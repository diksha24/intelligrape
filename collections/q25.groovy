...
Employee e1=new Employee(name:'Aanchal',age:23 as byte,dept:'Finance',e_no:101,salary:20000)
Employee e2=new Employee(name:'kunal',age:53 as byte,dept:'Marketing',e_no:102,salary:2000)
Employee e3=new Employee(name:'tarun',age:83 as byte,dept:'Manufacturing',e_no:103,salary:3000)
